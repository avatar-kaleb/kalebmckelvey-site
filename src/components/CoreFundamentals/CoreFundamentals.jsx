  ...
  <div className="wrapper-flex-column--center md-grid mobile-fix">
    <Card className="md-cell md-cell--8 md-cell--10-tablet">
      ...
      <CardText className="animated zoomInUp cardText-text">
        ...
        <p>
          Below are the core foundations I believe in that will assist our journey towards achieving anything we want in
          life! Learn about where these fundamentals will take you by checking out
          {' '}
        ...
        <p>
          <em>
            These fundamentals will be continuously improved when new ideas are developed and each will be written about
            in the future.
          </em>
        </p>
        ...
        <ul>
          <li>
            ...
            <ul>
              ...
              <li>
                <a href="https://kalebmckelvey.com/each-day-in-our-lives-matter-live-them-with-purpose/" rel="noopener">
