        ...
        <Card className="md-cell md-cell--8 md-cell--10-tablet" title="Disclaimer">
          <CardText>
            <div>
              ...
              provided by <i>Kaleb McKelvey</i> and while we endeavour to keep the information up to date and correct,
              ...
              on such information is therefore strictly at your own risk. In no event will we be liable for any loss or
              ...
              website. Through this website you are able to link to other websites which are not under the control of{" "}
              <i>Kaleb McKelvey</i>. We have no control over the nature, content and availability of those sites. The
              inclusion of any links does not necessarily imply a recommendation or endorse the views expressed within
              them. Every effort is made to keep the website up and running smoothly. However, <i>Kaleb McKelvey</i>{" "}
              takes no responsibility for, and will not be liable for, the website being temporarily unavailable due to
