    ...
    <Card className="md-cell md-cell--8 md-cell--10-tablet" title="Disclaimer">
      <CardText>
        <p>
          ...
          <i>Kaleb McKelvey</i>
          &nbsp; and while we endeavour to keep the information up to date and correct, we make no
          ...
          risk. In no event will we be liable for any loss or damage including without limitation,
          ...
          control of &nbsp;
          <i>Kaleb McKelvey</i>. We have no control over the nature, content and availability of
          those sites. The inclusion of any links does not necessarily imply a recommendation or
          endorse the views expressed within them. Every effort is made to keep the website up and
