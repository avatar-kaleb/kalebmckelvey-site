    ...
    return (
      <div className="wrapper-flex-column--center md-grid mobile-fix">
        <Card className="md-cell md-cell--8 md-cell--10-tablet" title="Terms and Conditions">
          <CardText>
            <div>
              Welcome to <i>Kaleb McKelvey</i>. If you continue to browse and use this website you are agreeing to
              comply with and be bound by the following terms and conditions of use, which together with our privacy
              policy govern <i>Kaleb McKelvey</i>&apos;s relationship with you in relation to this website. The term{" "}
              <i>Kaleb McKelvey</i> or &apos;us&apos; or &apos;we&apos; refers to the owner of the website. The term
              &apos;you&apos; refers to the user or viewer of our website. The use of this website is subject to the
