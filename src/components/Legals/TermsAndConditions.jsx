    ...
    return (
      <div className="legals-wrapper md-grid mobile-fix">
        ...
        >
          <CardText>
            <div>
              Welcome to <i>Kaleb McKelvey</i>. If you continue to browse and
              ...
              privacy policy govern <i>Kaleb McKelvey</i>&apos;s relationship
              with you in relation to this website. The term{" "}
              <i>Kaleb McKelvey</i> or &apos;us&apos; or &apos;we&apos; refers
              to the owner of the website. The term &apos;you&apos; refers to
