  ...
  <div className="about-me wrapper-flex-column--center md-grid mobile-fix">
    <Card className="md-cell md-cell--8 md-cell--10-tablet">
      ...
      <CardText className="animated slideInUp slow cardText-text">
        ...
        <p>
          <strong>
            I help solve business problems through modern custom web
            applications.
          </strong>
        </p>
        <p>
          Combining leadership and technical skills, I collaborate with our team
        ...
        <p>
          ...
          technologies and focus on improving code bases as I learn from
          mistakes, grow through experience, and heed the advice from top
          developers on the web!
        </p>
        <h1>My Skills:</h1>
        <p>
          In the last few years I&#39;ve been offered the opportunities to learn
          and grow through various experiences.
        </p>
        <h2>Modern Web Development:</h2>
        <p>
          I&#39;ve worked on multiple projects utilizing various technologies,
        ...
        <h2>Leadership:</h2>
        <p>
          I graduated from GE&apos;s Digital Technology Leadership Program in
          February 2017. From this, I led through experience and learned from
          many top IT professionals in GE. Becoming a tech lead on our Milwaukee
          Software team, I mentored junior team members, led initiatives,
          improved our code base with every new feature, and helped architect
          designs to meet requirements from our Product Owners.
          <br />
          <br />I look forward to continuing using this experience in my new
          role!
        </p>
        <br />
        <DataTable plain>
        ...
        <h2>AX Dynamics:</h2>
        <p>
          4+ years of development experience designing custom solutions to meet
          user needs, providing business value.
        </p>
        <DataTable plain>
          <TableHeader>
            <TableRow>
        ...
        <h1>My Story</h1>
        <p>
          I believe everyone has a wonderful story to explain how in the world
          they got to the current moment we call now. Here&#39;s a bit of mine!
        </p>
        <h2>TLDR:</h2>
        <p>
          I&apos;m Kaleb McKelvey, a small town raised young professional, who
          focuses on exhibiting high character combined with strong ambition to
          continously grow a little bit each day.
          <br />
          <br />I began my career working as a Jr AX Dynamics developer at
          Shentel, transitioned to a leadership program at GE Healthcare which
          led to becoming a Staff Software Engineer; since then, I made the move
          to a new industry and city - New York - to close the distance with my
          girlfriend and take on a new role!
          <br />
          <br />
          My experiences in leadership and technical depth, has molded me into a
          well rounded Software Engineer who has a true passion for technology!
        </p>
        <h2>Long Version</h2>
        <p>
          I&apos;m a young professional with aspirations to inspire, grow, and
          achieve in various areas of my life.
        </p>
        <h3>Small town life</h3>
        <p>
          Growing up in a small town built the foundation of who I am today in a
          few ways.
        </p>
        <p>
          ...
          Lastly, it gave me the opportunity to understand that boredom can be
          replaced with canoe trips down the river, swimming in the quarry, and
        ...
        <p>
          ...
          with unique stories. A place to learn how to develop software from
          experts and the skill of time management through balance.
        </p>
        <p>
          By graduation, I completed my dream of learning to develop and became
          a member of the greatest fraternity in the world, Kappa Alpha Psi.
        </p>
        <p>
          My family, fraternity brothers, and colleagues guided me to a new
          vision on life, one that looks at the future as much as the present.
        </p>
        <h3>Becoming a Software Engineer!</h3>
        <p>
          After college, I began working at GE in their Digital Technology
          Leadership Program that led to achieving my dream of becoming a
          Software Engineer in my first role after graduating! GE is a company
          that focuses on the development of both technical and leadership
          skill-sets. Because of this, I have grown in both my professional and
          personal worlds thanks to the fabulous people I&apos;ve met on the
          way.
        </p>
        <p>
          A few years later, I decided to change cities and change industries. I
          joined Northwestern Mutual - a company that has more than a century
          under its belt -&nbsp; adventuring through a digital transformation.
          Personal finance has long been a passion of mine, so getting an
          opportunity to spend 40+ hours a week developing software to help
        ...
        <p>
          With all that being said, I look forward to hearing from you -
