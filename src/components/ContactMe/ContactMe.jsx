...
class ContactMe extends Component {
  render() {
    return (
      <div className="contactMe-wrapper wrapper-flex-column--center md-grid mobile-fix">
        <Paper className="md-cell md-cell--12 md-grid contactMe-paper--white" zDepth={0}>
          ...
          <section className="md-cell md-cell--center md-cell--middle md-cell--1-desktop-offset md-cell--1-tablet-offset md-cell--6-desktop md-cell--3-tablet">
            <div className="animated fadeInDown cardText-text">
              ...
              <p>
                Want to connect, have a question, or suggestion? I always enjoy hearing from people who have stopped by
                the site!
              </p>
              <p>
                Send over an e-mail at: <a href="mailto:kalebmckelvey3@gmail.com">KalebMcKelvey3@gmail.com</a>!
              </p>
