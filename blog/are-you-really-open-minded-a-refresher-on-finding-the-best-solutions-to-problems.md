...
tags:
  ...
  - listening
---
Throughout the summer I've been reading through critical thinking books, such as *Thinking Fast and Slow*, *The Art of Critical Thinking*, *Super Thinking: The Big Book of Mental Models*, and now currently working on *Principles* by Ray Dalio.

I really have enjoyed the book and it has been interesting to learn how different leaders approach the company in which they lead in such various ways. Mr. Dalio split principles up into three parts, first giving an introduction to who he is, followed by life principles, and ending with work principles. I wanted to touch on one chapter in part two, **Be Radically Open-Minded** because as a software developer and future husband, it hit home for me.

*Note: anything in quotes throughout the article will be quotes from the book!*
...
Ray mentioned how some people can see big picture vision but miss small details, while others are opposite. Some are lateral while other are linear thinkers. There are people who are task executors and people who are go-with-the-flow creators. 

Each and everyone of us is different and we must accept that we have blindspots so others can help us out. 

It's similar to checking your blind spot in your car - since you know the blind spot exists in the mirror, you check over your shoulder to make sure there isn't a car there. 

## Change Your Perspective by Practicing Radical open-mindness

To get better at making decisions and learning to disregard some of the emotions from our inner subconscious during open discussions, we must first change your perspective on one key point.
...
This means to actually explore and understand the different points of view and possibilities when discussing solutions with your colleagues. It requires your thinking to change from being RIGHT or WRONG to finding the BEST answer.

One of my favorite sentences of the chapter is below that I really joined:
...
The book guides us on how to best to this through a few principles I'll summarize below.

### Accept that you might not know the best possible answer

With this new perspective in mind, you can now openly discuss and listen to others in the discussion to make the best decision. Before starting to do so, ACCEPT that you might not have the best answer, so listen and ***understand*** the disagreeing party's point of view.

### Decision Making has Two-Steps

Mental models show us that as humans we have biases and Daniel Kahneman recognized that many of times our decision making is based on fast-thinking, before even considering all of the data. The brain does this to save energy, since brain powering takes quite a lot of calories to work :).
...
Just WOW! I just can't point it any better than that and it MAKES so much sense.


##### Have Clear Objectives:

Further, one should be clear on what you want to know and the reason for wanting to change or make this decision.
...
Once step one has been completed, now is the time to make a decision. I believe that one of the best ways to base decisions requires having guiding objectives or goals to base it on. 
...
1. "Closed-minded people are more likely to make statements than ask questions."
1. "Closed-minded people focus much more on being understood than on understanding others."
1. "Closed-minded people say things like 'I could be wrong...but here's my opinion."
1. "Closed-minded people block others from speaking."
1. "Closed-minded people have trouble holding two thoughts simultaneously in their minds."
1. "Closed-minded people lack a deep sense of humility."
